 ...
 */
public final class JBudaException extends Exception {
    ...
    public JBudaException(String message) {
        super(message);
        this.httpStatusCode = 0;
        this.message = message;
        this.code = "";
    ...
    public JBudaException(final int httpStatusCode, final String message, final String code, final Detail[] details) {
    ...
    public JBudaException(final int httpStatusCode, final Throwable cause, final String message, final String code, final Detail[] details) {
    ...
    public JBudaException(final int httpStatusCode, final Throwable cause, final boolean enableSuppression, final boolean writableStackTrace, final String message, final String code, final Detail[] details) {
    ...
    private static String message(final int httpStatusCode, final String message, final String code, final Detail[] details) {
        ...
        String template = "Buda request failed. %n HTTP Status Code: %d,%n Message: '%s',%n Code: '%s',%n Details:%n%s";
